...
pub fn read_op(bytecode: &[u8], off: usize) -> Result<(BytecodeInstruction, usize), usize> {
    ...
    Result::Ok(match bytecode[off] {
        ...
        0xa2 => (BytecodeInstruction::IfICmp(BytecodeCondition::Gt, off.wrapping_add(read_u16(bytecode, off + 1)? as i16 as isize as usize)), 3),
        0xa3 => (BytecodeInstruction::IfICmp(BytecodeCondition::Ge, off.wrapping_add(read_u16(bytecode, off + 1)? as i16 as isize as usize)), 3),
        ...
        0x9c => (BytecodeInstruction::If(BytecodeCondition::Gt, off.wrapping_add(read_u16(bytecode, off + 1)? as i16 as isize as usize)), 3),
        0x9d => (BytecodeInstruction::If(BytecodeCondition::Ge, off.wrapping_add(read_u16(bytecode, off + 1)? as i16 as isize as usize)), 3),
