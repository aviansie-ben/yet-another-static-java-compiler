...
pub enum BytecodeInstruction {
    ...
    IConst(i32),
    IDiv,
    IfACmp(BytecodeCondition, i16),
    IfICmp(BytecodeCondition, i16),
    If(BytecodeCondition, i16),
    IfNonNull(i16),
    IfNull(i16),
    IInc(u16, i16),
    ILoad(u16),
...
pub fn read_op(bytecode: &[u8], off: usize) -> Result<(BytecodeInstruction, usize), usize> {
    ...
    Result::Ok(match bytecode[off] {
        ...
        0xa7 => (BytecodeInstruction::Goto(read_u16(bytecode, off + 1)? as i16 as i32), 3),
        0xc8 => (BytecodeInstruction::Goto(read_u32(bytecode, off + 1)? as i32), 5),
        ...
        0xa5 => (BytecodeInstruction::IfACmp(BytecodeCondition::Eq, read_u16(bytecode, off + 1)? as i16), 3),
        0xa6 => (BytecodeInstruction::IfACmp(BytecodeCondition::Ne, read_u16(bytecode, off + 1)? as i16), 3),
        0x9f => (BytecodeInstruction::IfICmp(BytecodeCondition::Eq, read_u16(bytecode, off + 1)? as i16), 3),
        0xa0 => (BytecodeInstruction::IfICmp(BytecodeCondition::Ne, read_u16(bytecode, off + 1)? as i16), 3),
        0xa1 => (BytecodeInstruction::IfICmp(BytecodeCondition::Lt, read_u16(bytecode, off + 1)? as i16), 3),
        0xa2 => (BytecodeInstruction::IfICmp(BytecodeCondition::Gt, read_u16(bytecode, off + 1)? as i16), 3),
        0xa3 => (BytecodeInstruction::IfICmp(BytecodeCondition::Ge, read_u16(bytecode, off + 1)? as i16), 3),
        0xa4 => (BytecodeInstruction::IfICmp(BytecodeCondition::Le, read_u16(bytecode, off + 1)? as i16), 3),
        0x99 => (BytecodeInstruction::If(BytecodeCondition::Eq, read_u16(bytecode, off + 1)? as i16), 3),
        0x9a => (BytecodeInstruction::If(BytecodeCondition::Ne, read_u16(bytecode, off + 1)? as i16), 3),
        0x9b => (BytecodeInstruction::If(BytecodeCondition::Lt, read_u16(bytecode, off + 1)? as i16), 3),
        0x9c => (BytecodeInstruction::If(BytecodeCondition::Gt, read_u16(bytecode, off + 1)? as i16), 3),
        0x9d => (BytecodeInstruction::If(BytecodeCondition::Ge, read_u16(bytecode, off + 1)? as i16), 3),
        0x9e => (BytecodeInstruction::If(BytecodeCondition::Le, read_u16(bytecode, off + 1)? as i16), 3),
        0xc7 => (BytecodeInstruction::IfNonNull(read_u16(bytecode, off + 1)? as i16), 3),
        0xc6 => (BytecodeInstruction::IfNull(read_u16(bytecode, off + 1)? as i16), 3),
